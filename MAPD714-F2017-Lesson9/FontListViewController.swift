...
//utility method
    func fontForDisplay(atIndexObjectPath indexPath: NSIndexPath) -> UIFont? {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.font = fontForDisplay(atIndexObjectPath: indexPath as NSIndexPath)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        ...
        let font = fontForDisplay(atIndexObjectPath: indexPath as NSIndexPath)
